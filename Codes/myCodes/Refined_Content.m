clear Refined_data Truth_value Refined_data_FinalV R pca_data RMFV
%%
...
%% Further Process 2 (obtain the truth value table)
...
% RMFV: truth_values-> col (1)
%       features table -> col (3:end)

for i = 1: size(Refined_data_FinalV,2)
    RMFV (:, i+1) = cell2mat(Refined_data_FinalV(:,i));
end
