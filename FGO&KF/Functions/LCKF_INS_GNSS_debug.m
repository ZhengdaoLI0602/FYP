function [LCKF_result,GNSS_llh,IMU_data] = LCKF_INS_GNSS_debug(GNSS_data, IMU_data,...
...
if whether_adaptive == 1
    adaptiveR = ml_prediction(1,3) * 10;
...
for epoch = 2:no_epochs_IMU 
    ...
    if abs(float_GNSS_epoch-floor_epoch)<5e-3 || abs(float_GNSS_epoch-ceil_epoch)<5e-3 
